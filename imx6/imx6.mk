...
PRODUCT_COPY_FILES +=	\
	...
	device/fsl/common/security/lighthousenetwork.x509.pem:system/etc/security/shift4.x509.pem \
	device/fsl/common/security/harbortouch_pos.x509.pem:system/etc/security/harbortouch_pos.x509.pem \
